export default function FloatingCTA() {
  ...
  return (
    <>
      ...
      <a
        href={`https://wa.me/91${phoneNumber}?text=Hi!%20I%20am%20interested%20in%20ordering%20Chaitanya%20cold-processed%20soaps.`}
        target="_blank"
      ...
      <a
        ...
        className="fixed bottom-6 left-6 z-50 w-14 h-14 bg-soap-sage rounded-full flex items-center justify-center shadow-lg shadow-soap-sage/30 hover:scale-110 hover:shadow-xl transition-all duration-300 md:hidden"
